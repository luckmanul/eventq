...
export class QManageWSService {
    ...
    connect(connectCallback) {
        ...
        let url;
        url = '//' + loc.host + loc.pathname + 'websocket/qmanage';
    ...
    private onConnected(parent: QManageWSService, connectCallback) {
    ...
    sendActivity() {
        if (this.stompClient !== null && this.stompClient.connected) {
            this.stompClient.send(
                '/topic/qmanage-activity', // destination
    ...
    subscribe() {
        this.connection.then(() => {
            this.subscriber = this.stompClient.subscribe('/topic/qmanage-subscriber', (data) => {
