...
import id.co.company.eventq.domain.Authority;
import id.co.company.eventq.domain.User;
import id.co.company.eventq.repository.AuthorityRepository;
import id.co.company.eventq.repository.UserRepository;
import id.co.company.eventq.security.AuthoritiesConstants;
import id.co.company.eventq.service.MailService;
import id.co.company.eventq.service.UserService;
import id.co.company.eventq.service.dto.UserDTO;
import id.co.company.eventq.web.rest.vm.KeyAndPasswordVM;
import id.co.company.eventq.web.rest.vm.ManagedUserVM;
